...
extern "C" pointer mem_new_rec ARGS((rec_mgr));
extern "C" void mem_free_rec ARGS((rec_mgr, pointer));
extern "C" rec_mgr mem_new_rec_mgr ARGS((int));
extern "C" void mem_free_rec_mgr ARGS((rec_mgr));
#else
